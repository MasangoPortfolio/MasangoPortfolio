...
`Python` · `PowerShell` ·`Bash`· `Blurp` · `Azure` · `Packet Tracer` · `Linux` · `Windows` · `SQL`  · `C++`
...
[LinkedIn](https://www.linkedin.com/in/emmanuel-masango/) 
[TryHackMe](https://tryhackme.com/p/DreamingDragon)

---
- ⚡ Fun fact: I once walked 50 450 steps in a day 
-->
